 ...
 */
    ...
    int main(){
        ...
        for(int year=1; year<=30; year++){
            if(year*increase<=9.9&&year<=30){
                cout << setfill('0') << year << "\t" << showpoint << setprecision(2) << year*increase << endl;
            }
            if(year*increase>=10&&year*increase<=99.9&&year<=30){
                cout << setfill('0') << year << "\t" << showpoint << setprecision(3) << year*increase << endl;
            }
            if(year*increase>=100&&year*increase<=999.9&&year<=30){
                cout << setfill('0') << year << "\t" << showpoint << setprecision(4) << year*increase << endl;
            }
            if(year*increase>=1000&&year<=30){
                cout << setfill('0') << year << "\t" << showpoint << setprecision(5) << year*increase << endl;
            }
        }
        return 0;
    }
